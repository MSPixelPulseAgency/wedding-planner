...
Route metadata is exported from `src/data/siteData.js`. `scripts/postbuild.mjs` uses it to create route-specific HTML, canonicals, Open Graph/Twitter tags, JSON-LD, a no-script content fallback, the sitemap and social image.
