...
Run `npm run lint && npm test && npm run build && npm run check:seo`, inspect responsive containment and verify direct nested-route refreshes before release.
